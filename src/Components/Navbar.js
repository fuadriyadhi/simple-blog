...
export default function Navbar() {
  ...
  return `
    <nav class="w-full h-20 flex bg-slate-800 sticky left-0 top-0 shadow-md">
        <div class="w-full max-w-[1440px] flex items-center justify-start px-4 mx-auto">
            ...
            <menu class="flex gap-4 text-white font-light items-center ml-auto">
                ...
                <span class="bg-slate-700 px-4 py-2 rounded-full cursor-default" >${JSON.parse(userData).user.email}</span>
            </menu>`
                : `
            <menu class="flex gap-4 text-white font-light items-center ml-auto">
                <a href="/">Home</a>
